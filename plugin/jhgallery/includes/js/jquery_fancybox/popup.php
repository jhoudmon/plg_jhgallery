                ...
                $('a.fancybox-gallery').fancybox({
                    ...
                    beforeShow: function(instance, current) {
                        if (current.type === 'image') {
                            ...
                            current.opts.caption = (title.length ? '<b class=\"fancyboxCounter\">".JText::_('PLG_JHGALLERY_FB_IMAGE')." ' + (current.index + 1) + ' ".JText::_('PLG_JHGALLERY_FB_OF')." ' + instance.group.length + '</b>' : '');
                        }
                    }
                });
            });
